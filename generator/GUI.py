...
class GenerateWindow(tk.Tk):
    ...
    def __init__ (self, *args, **kwargs):
        ...
        self.saveButton = tk.Button(self.outputFrame, text = "Create World", bg = "lightblue", state = "disabled", command = self.savePressed)
        ...
        self.advTiles.grid(row = 0, column = 1, sticky = (tk.N, tk.E, tk.S, tk.W))
        ...
        self.advHumans.grid(row = 1, column = 1, sticky = (tk.N, tk.E, tk.S, tk.W))
